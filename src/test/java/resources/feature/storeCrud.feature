Feature:BestBuy Application
  ...
  Scenario Outline: CRUD Test
    ...
    And I update a store with storeId and give information storeId "39" name "tv1", address "ALPHA testing", city "loNDON", state "WALES", zip "we3wr", type  "abcd", address- "highway", lat "20",lng "10",hours "11:11",services "LMNO"
    ...
    Examples:
      ...
      | TUSHAR | prime Testing | abcd | auto  | 102df | best | avenue   | 10  | 100 | 10:15 | tesla    |
